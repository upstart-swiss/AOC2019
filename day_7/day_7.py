...
class ImediateProcessor(OpCodeProcessor):
...
def test_day2():
    assert ImediateProcessor([1,0,0,0,99]).opcodes == [2,0,0,0,99]
    assert ImediateProcessor([2,3,0,3,99]).opcodes == [2,3,0,6,99]
    assert ImediateProcessor([2,4,4,5,99,0]).opcodes == [2,4,4,5,99,9801]
    assert ImediateProcessor([1,1,1,4,99,5,6,0,99]).opcodes == [30,1,1,4,2,5,6,0,99]
...
def test_day5():
    ...
    assert ImediateProcessor(day_5_input, inputs=["1"]).outputs[-1] == 13547311
    assert ImediateProcessor(day_5_input, inputs=["5"]).outputs == [236453]
...
if __name__ == "__main__":
    ...
    # op.run()
    highest, combo = get_highest_signal(day_7_codes)
    print(f"HIghest combo is {highest} from {combo}")
    highest, combo = get_highest_signal(day_7_codes, True)
